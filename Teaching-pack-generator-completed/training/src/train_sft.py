...
def prepare_dataset(dataset_name: str, dataset_split: str, tokenizer):
    ...
    if 'text' in dataset.features:
        ...
        print("Dataset has 'messages' column.")
    else:
        def format_dataset(example):
            ...
            try:
                ...
                response = f"Correct answer: {answer_key}. {texts[correct_idx]}"
            except (ValueError, IndexError):
                response = f"Correct answer: {answer_key}"
...
def main():
    ...
    print("=" * 50)
    print(f"Training SFT model: {args.model_name}")
